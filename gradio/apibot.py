...
def chatbot_conversation(message, chat_history=None):
    ...
    chat_response = client.agents.complete(
        agent_id="ag:fe8dcc97:20250305:maxibot-api-platform:fada382c",
...
chat_interface = gr.ChatInterface(
    ...
    type="messages",
    title="ApiPlatform Bot 🤖",
    description="Posez vos questions sur ApiPlatform. Ce chatbot est alimenté par Mistral.",
)
